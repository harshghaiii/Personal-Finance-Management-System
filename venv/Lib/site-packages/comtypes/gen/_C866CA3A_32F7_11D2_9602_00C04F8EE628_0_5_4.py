...
__all__ = [
    'SPINTERFERENCE_TOOFAST', 'DISPID_SpeechVoice', 'SP_VISEME_11',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MAX_TTS',
    'DISPID_SRCEFalseRecognition', 'SPEI_UNDEFINED', 'SPAS_CLOSED',
    'SGLexicalNoSpecialChars', 'SpeechSpecialTransitionType',
    'DISPID_SPCLangId', 'DISPID_SPRsCount', 'SECFIgnoreWidth',
    'SECFIgnoreCase', 'DISPID_SGRSTNextState',
    'SpeechRecognitionType', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechObjectToken',
    'DISPID_SpeechRecoResult2', 'eWORDTYPE_DELETED', 'DISPID_SPPId',
    'SPFILEMODE', 'SPLO_STATIC', 'DISPID_SRGCommit',
    'DISPID_SGRSTPropertyName', 'SREStreamEnd', 'SRADefaultToActive',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRCEBookmark',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCEEnginePrivate',
    'SAFT22kHz8BitStereo', 'SpeechVoiceCategoryTTSRate',
    'STSF_AppData', 'ISpeechMMSysAudio', 'SAFTCCITT_ALaw_22kHzMono',
    ...
    'eLEXTYPE_PRIVATE11', 'eLEXTYPE_PRIVATE5', 'SpeechVisemeFeature',
    'ISpRecoResult', 'SPPS_Interjection', 'SRTEmulated', 'SDTAudio',
    'SVP_0', 'SPEI_WORD_BOUNDARY', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRSRule', 'DISPID_SPIGrammarId', 'SpeechRuleAttributes',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE10',
    'SPEI_END_INPUT_STREAM', 'SpeechEngineConfidence',
    'DISPID_SpeechMMSysAudio', 'SPPARTOFSPEECH',
    'DISPID_SPPConfidence', 'DISPID_SPRuleId', 'SINoise',
    'eLEXTYPE_PRIVATE16', 'SGRSTTEpsilon',
    'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEEnginePrivate', 'SPEI_TTS_BOOKMARK', 'SP_VISEME_13',
    'ISpeechPhraseRules', 'SAFT11kHz8BitMono', 'SGDSInactive',
    ...
    'DISPID_SRSetPropertyString', 'SPBO_NONE',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRSClsidEngine',
    '_RemotableHandle', 'DISPID_SPAsCount', 'DISPID_SRIsShared',
    'SPBO_AHEAD', 'eLEXTYPE_RESERVED7', 'SAFTCCITT_ALaw_11kHzMono',
    'SP_VISEME_5', 'DISPID_SRRecognizer', 'SPSHT_NotOverriden',
    'SPPHRASEELEMENT', 'SVEWordBoundary', 'SpeechTokenValueCLSID',
    'SWPKnownWordPronounceable', 'SDA_Two_Trailing_Spaces',
    'ISpeechRecognizer', 'ISpPhoneConverter', 'SVPOver',
    'SECFEmulateResult', 'SPEI_TTS_AUDIO_LEVEL', 'SRAInterpreter',
    'DISPID_SVEPhoneme', 'DISPID_SPRuleEngineConfidence',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SpeechLexiconWords',
    'ISpRecoGrammar2', 'SPAR_Medium', 'SPSEMANTICERRORINFO',
    'SPSMF_UPS', 'SAFT12kHz8BitMono', 'SVP_20', 'SVP_15',
    'SpInprocRecognizer', 'SPSHT_EMAIL', 'DISPID_SGRClear',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SpeechRecoResultTimes',
    'SAFT48kHz16BitStereo', 'SPEI_RESERVED1',
    'DISPID_SDKGetStringValue',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechPhraseElement',
    'SVEPrivate', 'SpAudioFormat',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_PHONEME',
    'SpeechAudioProperties', 'DISPID_SVStatus',
    'DISPID_SASFreeBufferSpace', 'eLEXTYPE_RESERVED4',
    'eLEXTYPE_PRIVATE13', 'SGDSActiveWithAutoPause', 'SPEVENT',
    'ISpEventSource', 'SPSHORTCUTPAIR', 'DISPID_SpeechPhraseRules',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_REQUEST_UI',
    'SPPS_RESERVED4', 'SGRSTTWord', 'DISPID_SRRTStreamTime',
    'DISPID_SLPsItem', 'DISPID_SWFEExtraData',
    'DISPID_SGRSAddSpecialTransition', 'SPSHORTCUTTYPE',
    'SAFT32kHz16BitStereo', 'DISPID_SLPPhoneIds', 'ISpSerializeState',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechLexiconPronunciations',
    'DISPID_SPEAudioSizeBytes', 'SVEAllEvents', 'IEnumString',
    'DISPID_SpeechCustomStream', 'DISPID_SPEsItem', 'SVP_18',
    'DISPID_SVAudioOutput', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechAudioStatus', 'DISPID_SPEPronunciation',
    'SVSFIsFilename', 'SVSFNLPMask', 'SPEVENTSOURCEINFO',
    'ISpShortcut', 'DISPID_SVAlertBoundary', 'SpeechVisemeType',
    'DISPID_SpeechRecognizerStatus', 'SPSERIALIZEDRESULT',
    'DISPID_SADefaultFormat', 'DISPID_SDKSetStringValue',
    'SpeechGrammarWordType', 'SVSFPurgeBeforeSpeak',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPVPRI_NORMAL',
    'DISPID_SGRSAddWordTransition', 'SPSUnknown', 'ISpeechAudio',
    'SREFalseRecognition', 'DISPID_SVSyncronousSpeakTimeout',
    'SDTPronunciation', 'DISPID_SVEVoiceChange', 'SPWAVEFORMATTYPE',
    'SREStateChange', 'SpeechRetainedAudioOptions', 'ISpRecognizer3',
    'SPXMLRESULTOPTIONS', 'SECFDefault', 'DISPID_SGRAddState',
    'SPLOADOPTIONS', 'DISPID_SRCEAudioLevel',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPFM_CREATE',
    'DISPID_SOTs_NewEnum', 'SRAONone', 'SECHighConfidence',
    ...
    'SREBookmark', 'SVP_17', 'SpeechDisplayAttributes',
    'SSFMOpenReadWrite', 'DISPID_SRRPhraseInfo', 'DISPID_SRCState',
    'SPCT_COMMAND', 'DISPID_SpeechAudio', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SGRId',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechPartOfSpeech',
    'SpeechTokenShellFolder', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SGRName', 'SVP_10', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechPhraseReplacement', 'DISPID_SASCurrentSeekPosition',
    'ISpRecognizer2', 'STCAll', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SWFEChannels', 'SpObjectTokenCategory',
    'SpeechEngineProperties', 'DISPID_SGRSTType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'STCInprocHandler',
    'eLEXTYPE_PRIVATE9', 'SVEAudioLevel', 'DISPID_SPPsItem',
    'SITooQuiet', 'SPINTERFERENCE_NOSIGNAL', 'SPFM_OPEN_READWRITE',
    'SpeechTokenIdUserLexicon', 'DISPID_SABufferInfo',
    'DISPID_SVSpeak', 'SPEI_START_INPUT_STREAM', 'SAFT32kHz8BitMono',
    'SVSFUnusedFlags', 'ISpeechPhraseInfo',
    'DISPID_SVSInputWordLength', 'SAFT16kHz8BitMono',
    'SAFT44kHz16BitMono', 'SBONone', 'SPSHT_OTHER',
    'SpeechMicTraining', 'SAFT44kHz8BitStereo',
    'SpeechTokenKeyAttributes', 'SPCS_ENABLED',
    'DISPID_SAFSetWaveFormatEx', 'SASPause',
    'DISPID_SVAudioOutputStream', 'DISPID_SPEDisplayAttributes',
    'SpeechCategoryAppLexicons', 'SPRST_INACTIVE_WITH_PURGE',
    'SSSPTRelativeToEnd', 'DISPID_SPRs_NewEnum', 'SVF_Emphasis',
    'SAFTNoAssignedFormat', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SECFIgnoreKanaType', 'SSFMOpenForRead', 'SP_VISEME_9',
    'DISPID_SPRuleParent', 'DISPID_SLPLangId', 'SPAR_Low',
    'ISpObjectTokenCategory', 'SPPHRASEPROPERTY',
    'ISpeechPhraseElements', 'DISPID_SPRuleConfidence',
    'SPSInterjection', 'DISPID_SRGRecoContext',
    'DISPID_SPIAudioStreamPosition', 'SRTSMLTimeout',
    'ISpeechRecoResultDispatch', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechObjectTokens', 'ISpRecoContext2',
    'SpeechRecoProfileProperties', 'SRSActive',
    'DISPID_SOTGetAttribute', 'SVPAlert',
    'SSSPTRelativeToCurrentPosition',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRStatus',
    'DISPID_SpeechLexicon', 'DISPID_SPILanguageId',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPEs_NewEnum',
    'SpCustomStream', 'SAFTCCITT_uLaw_11kHzMono',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechGrammarRuleState',
    'ISpeechPhraseProperty', 'SAFTGSM610_22kHzMono',
    'DISPID_SVSVisemeId', 'eLEXTYPE_PRIVATE18',
    'SpeechCategoryRecoProfiles', 'SpeechGrammarTagDictation',
    'SpStream', 'eLEXTYPE_PRIVATE15', 'SRERecognition',
    'ISpeechRecognizerStatus', 'DISPID_SCSBaseStream',
    'DISPID_SGRsAdd', 'SP_VISEME_0', 'SAFTText', 'DISPID_SMSALineId',
    'SAFT24kHz8BitMono', 'SDKLLocalMachine',
    'DISPID_SpeechBaseStream', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SVPause', 'DISPID_SGRsCommit', 'DISPID_SPPFirstElement',
    'DISPID_SPPParent', 'SPCT_SLEEP', 'SITooLoud',
    'DISPID_SDKEnumValues', 'DISPID_SBSWrite',
    'DISPID_SRGSetWordSequenceData', 'SpeechLoadOption',
    'DISPID_SPCPhoneToId', 'DISPID_SRRTLength', 'SREAudioLevel',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVEBookmark',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCEStartStream',
    '__MIDL_IWinTypes_0009', 'SRAORetainAudio', 'SAFT8kHz16BitStereo',
    'DISPID_SRCEEndStream', 'DISPID_SpeechPhraseReplacement',
    'SDTReplacement', 'SPRULESTATE', 'eLEXTYPE_PRIVATE2',
    'DISPID_SPRsItem', 'SP_VISEME_10', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SOTsItem', 'DISPID_SVSLastBookmark',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRCPause',
    'ISpeechAudioFormat', 'ISpeechResourceLoader', 'DISPID_SPACommit',
    'DISPID_SPRFirstElement', 'DISPID_SPIStartTime', 'SPPS_RESERVED1',
    'SpMMAudioEnum', 'SVP_1', 'DISPID_SLWWord', 'SSTTWildcard',
    'SAFT48kHz8BitMono', 'SVP_14', 'SPFM_OPEN_READONLY',
    'SRESoundEnd', 'SSSPTRelativeToStart', 'SPSModifier',
    'SECLowConfidence', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SFTInput', 'SPSFunction', 'DISPID_SDKDeleteKey',
    'SAFTCCITT_ALaw_8kHzStereo', 'SLODynamic', 'SVP_13',
    'STSF_FlagCreate', 'SpInProcRecoContext', 'SPVPRIORITY',
    'SPRECORESULTTIMES', 'SREAllEvents', 'ISpeechPhraseAlternate',
    'DISPID_SRCESoundStart', 'SPEI_VOICE_CHANGE', 'SPPS_Verb',
    'SpeechRecoContextState', 'SPSSuppressWord', 'SPBINARYGRAMMAR',
    'DISPID_SVEViseme', 'SP_VISEME_20', 'DISPID_SPELexicalForm',
    'DISPID_SAVolume', 'DISPID_SGRsDynamic', 'ISpeechRecoGrammar',
    'SVEVoiceChange', 'SPPHRASE', 'DISPID_SOTCreateInstance',
    'SPRST_INACTIVE', 'SpeechPropertyLowConfidenceThreshold',
    'UINT_PTR', 'DISPID_SREmulateRecognition', 'ISpEventSink',
    'DISPID_SRRTOffsetFromStart', 'SAFT12kHz8BitStereo',
    'ISpeechFileStream', 'SP_VISEME_14', 'SpeechInterference',
    'SVP_2', 'DISPID_SGRSTRule', 'DISPID_SOTGetDescription',
    'SGLexical', 'DISPID_SPAs_NewEnum', 'STCLocalServer',
    'SPEI_SR_BOOKMARK', 'SPPS_Modifier', 'DISPID_SMSADeviceId',
    'SAFTGSM610_8kHzMono', 'SpUnCompressedLexicon', 'SP_VISEME_17',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPPs_NewEnum',
    'SREStreamStart', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRGSetTextSelection', 'DISPID_SLPSymbolic', 'DISPIDSPTSI',
    'ISpPhoneticAlphabetConverter', 'SpNotifyTranslator',
    'SP_VISEME_2', 'DISPID_SPEAudioStreamOffset',
    'eLEXTYPE_PRIVATE12', 'SAFT24kHz8BitStereo',
    'ISpeechObjectTokenCategory', 'SPVPRI_ALERT',
    'SAFT16kHz8BitStereo', 'SSFMCreateForWrite', 'SRATopLevel',
    'SPEI_HYPOTHESIS', 'ISpRecoGrammar', 'SpeechCategoryVoices',
    'SDTDisplayText', 'ISpeechCustomStream', 'SGSExclusive',
    'DISPIDSPTSI_ActiveOffset',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SOTDataKey', 'DISPID_SRRTTickCount', 'DISPID_SPIElements',
    'SAFT22kHz16BitMono', 'SGRSTTDictation', 'ISpeechGrammarRules',
    'DISPID_SpeechWaveFormatEx', 'SDA_Consume_Leading_Spaces',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRDisplayUI',
    'DISPID_SLWs_NewEnum', 'SVP_6', 'DISPID_SpeechGrammarRules',
    'SRSInactive', 'DISPID_SpeechObjectToken', 'ISpObjectToken',
    'SLTUser', 'DISPID_SpeechVoiceEvent', 'DISPID_SFSOpen',
    'DISPID_SVEventInterests', 'SpeechDictationTopicSpelling',
    'SAFT8kHz16BitMono', 'DISPID_SGRSTPropertyId', 'SSTTDictation',
    'DISPID_SRRSpeakAudio', 'ISpeechRecoResultTimes',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SLOStatic', 'SP_VISEME_15',
    'DISPID_SLGetGenerationChange', 'eLEXTYPE_RESERVED10',
    'DISPID_SDKGetBinaryValue', 'SPGS_EXCLUSIVE', 'SPRECOSTATE',
    'DISPID_SPIRule', 'DISPID_SDKDeleteValue', 'SpMMAudioIn', 'SVP_4',
    'SVSFlagsAsync', 'SPWORDLIST', 'DISPID_SPRules_NewEnum',
    'SpeechTokenKeyFiles', 'SRTStandard', 'DISPID_SRGId',
    'SPRST_NUM_STATES', 'DISPID_SPIRetainedSizeBytes',
    'ISpeechPhraseRule', 'eLEXTYPE_APP', 'SVEEndInputStream',
    'DISPID_SLWLangId', 'DISPID_SOTId', 'ISpeechPhraseInfoBuilder',
    'SPWORDPRONOUNCEABLE', 'SpeechCategoryPhoneConverters',
    'DISPID_SRAudioInput', 'SPEI_VISEME', 'SAFT44kHz8BitMono',
    'SAFTADPCM_22kHzMono', 'SpeechRegistryUserRoot', 'SPAS_RUN',
    'DISPID_SVSPhonemeId', 'ISpeechTextSelectionInformation',
    'DISPID_SpeechPhraseInfo', 'SPRST_ACTIVE',
    'SpeechRegistryLocalMachineRoot', 'SINone',
    'SpeechStreamSeekPositionType', 'SVPNormal', 'SPPS_Noun',
    'ISpRecoContext', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechFileStream', 'SPAS_PAUSE', 'SPGRAMMARWORDTYPE',
    'ISpeechGrammarRuleStateTransition', 'SPAO_NONE', 'SVP_16',
    'DISPID_SRGCmdSetRuleIdState', 'SpTextSelectionInformation',
    'SPGRAMMARSTATE', 'SAFT12kHz16BitStereo', 'ISequentialStream',
    'DISPID_SPPNumberOfElements', 'SVP_19', 'SVEStartInputStream',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechPhraseElements',
    'DISPID_SVEWord', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPPS_NotOverriden', 'tagSTATSTG',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SOTsCount', 'SPSHORTCUTPAIRLIST', 'IStream',
    'DISPID_SFSClose', 'SAFT48kHz8BitStereo', 'SpLexicon',
    'DISPID_SRGetFormat', 'SAFT44kHz16BitStereo', 'eLEXTYPE_PRIVATE8',
    'SDA_One_Trailing_Space', 'DISPID_SGRSTWeight', 'SREPrivate',
    'SVP_12', 'DISPID_SDKCreateKey', 'DISPID_SWFEFormatTag',
    'SVSFDefault', 'ISpXMLRecoResult', 'DISPID_SPRuleName',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRSTs_NewEnum',
    'SpeechUserTraining', 'eWORDTYPE_ADDED', 'SPTEXTSELECTIONINFO',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SRRTimes',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRAudio', 'SpeechAllElements',
    'DISPID_SLWsCount', 'SPEI_TTS_PRIVATE', 'DISPID_SPISaveToMemory',
    'DISPID_SVEStreamStart', 'SPRST_ACTIVE_ALWAYS',
    'SAFT11kHz16BitStereo', 'SAFT22kHz8BitMono',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechLexiconProns',
    'eLEXTYPE_PRIVATE3', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechRuleState', 'DISPID_SRCVoice', 'ISpAudio',
    'DISPID_SLGenerationId', 'DISPID_SpeechXMLRecoResult',
    'SAFT32kHz16BitMono', 'DISPID_SVResume', 'SAFT48kHz16BitMono',
    'ISpPhrase', 'DISPID_SRRSetTextFeedback', 'ISpDataKey',
    'SpeechCategoryAudioIn', 'IEnumSpObjectTokens', 'DISPID_SVVolume',
    'DISPID_SWFESamplesPerSec', 'SECFNoSpecialChars',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechLexiconPronunciation',
    'SPINTERFERENCE_TOOSLOW', 'SASClosed',
    'SpeechCategoryRecognizers', 'ISpeechLexiconWord', 'SP_VISEME_21',
    'SLTApp', 'SpeechVoiceEvents', 'DISPID_SPEEngineConfidence',
    'SP_VISEME_12', 'DISPID_SVGetAudioInputs',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechLexicon',
    'tagSPPROPERTYINFO', 'SRERecoOtherContext', 'SpeechFormatType',
    'DISPID_SAEventHandle', 'SPCT_SUB_DICTATION', 'SASRun',
    'eLEXTYPE_RESERVED8', 'DISPID_SAFGuid',
    'DISPID_SVESentenceBoundary', 'DISPID_SRRAlternates',
    'SAFTCCITT_uLaw_22kHzMono', 'SSFMCreate', 'ISpeechGrammarRule',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCBookmark', 'SVP_9',
    'SECNormalConfidence', 'SPPROPERTYINFO', 'SDTAlternates',
    'DISPID_SRCRecognizer', 'SP_VISEME_1', 'DISPID_SGRsCommitAndSave',
    'DISPID_SpeechDataKey', 'SDTLexicalForm', 'SPWT_DISPLAY',
    'SPWT_PRONUNCIATION', 'SpeechCategoryAudioOut', 'ISpNotifySource',
    'SpNullPhoneConverter', 'ISpeechBaseStream',
    'DISPID_SVEAudioLevel', 'SWPUnknownWordPronounceable',
    'SDA_No_Trailing_Space', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPERequiredConfidence',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGState',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT11kHz8BitStereo',
    'DISPID_SGRsFindRule', 'SPGS_ENABLED', 'SGRSTTWildcard',
    'SGDSActiveUserDelimited', 'SPEI_END_SR_STREAM', 'SP_VISEME_3',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechPhraseElement',
    'SPGS_DISABLED', '_ISpeechRecoContextEvents', 'SGDisplay',
    'SPPS_RESERVED3', 'SVSFIsNotXML', 'DISPID_SRProfile',
    'DISPID_SRCERecognition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPRECOCONTEXTSTATUS', 'SpeechAudioVolume', 'SPWORD',
    'SpResourceManager', 'DISPID_SPIGetDisplayAttributes', 'SWTAdded',
    'SPRS_ACTIVE', 'SVEPhoneme', 'ISpRecognizer', 'SVEBookmark',
    'DISPID_SGRsCount', 'ISpGrammarBuilder', 'DISPID_SABIEventBias',
    'SPSERIALIZEDPHRASE', 'SpeechVoicePriority', 'ISpeechRecoResult2',
    'DISPID_SRRRecoContext', 'DISPID_SPRText', 'SGDSActive',
    'SPWORDTYPE', 'DISPID_SRGDictationLoad', 'DISPID_SRState',
    'SPAR_High', 'ISpeechXMLRecoResult', 'STSF_CommonAppData',
    'DISPID_SVRate', 'ISpObjectWithToken', 'SREInterference',
    'DISPID_SPRuleFirstElement', 'SPADAPTATIONRELEVANCE',
    'ISpLexicon', 'SVSFParseAutodetect', 'SpCompressedLexicon',
    'DISPID_SVIsUISupported', 'DISPID_SRGIsPronounceable',
    'DISPID_SVSCurrentStreamNumber', 'SPFM_NUM_MODES',
    'SpeechAudioFormatType', 'SPAUDIOSTATUS',
    'DISPID_SRCEInterference', 'SpeechRunState',
    'SpSharedRecoContext', 'DISPID_SVSLastStreamNumberQueued',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWF_INPUT',
    'DISPID_SPIEngineId', 'DISPID_SVSInputWordPosition',
    'SRTAutopause', 'eLEXTYPE_PRIVATE7', 'SREPhraseStart',
    'DISPID_SDKOpenKey', 'SVP_7', 'DISPID_SOTCSetId', 'SPAR_Unknown',
    'SpStreamFormatConverter', 'SPEI_RESERVED6',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_SOUND_START',
    'eLEXTYPE_PRIVATE17', '_ISpeechVoiceEvents', 'ISpeechRecoContext',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVVoice', 'DISPID_SLPType',
    'DISPID_SVGetProfiles', 'STCRemoteServer', 'DISPID_SPCIdToPhone',
    'eLEXTYPE_PRIVATE14', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRGetPropertyString', 'SPSEMANTICFORMAT',
    'ISpeechAudioStatus', 'SPVISEMES', 'DISPID_SPARecoResult',
    'SpMMAudioOut', 'SPEI_MAX_SR', 'SpeechEmulationCompareFlags',
    'DISPID_SBSRead', 'DISPID_SAStatus', 'SP_VISEME_7',
    'SPEI_SR_PRIVATE', 'DISPID_SPIGetText', 'DISPID_SVSkip',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTADPCM_44kHzMono',
    'ISpPhoneticAlphabetSelection', 'SDTProperty', 'SPSNotOverriden',
    'DISPID_SpeechPhraseBuilder',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRCERecognizerStateChange', 'SPEI_RESERVED3',
    'SPXRO_Alternates_SML', 'SVP_8', 'DISPID_SVEStreamEnd',
    'DISPID_SPRulesItem', 'DISPID_SpeechRecoContextEvents',
    'SRSEDone', 'SVSFParseSsml', 'SGRSTTTextBuffer', 'SpMemoryStream',
    'IInternetSecurityManager', 'DISPID_SBSSeek',
    'DISPID_SASNonBlockingIO', 'SPRECOGNIZERSTATUS', 'SP_VISEME_6',
    'SFTSREngine', 'DISPID_SLWPronunciations', 'SAFT24kHz16BitStereo',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTCategory',
    'SAFTADPCM_8kHzMono', 'SPVPRI_OVER', 'SPAUDIOSTATE',
    'SPEI_MIN_SR', 'SPWT_LEXICAL', 'ISpeechLexiconPronunciation',
    'SPVOICESTATUS', 'SPSNoun', 'LONG_PTR', 'DISPID_SOTRemove',
    'SPAUDIOOPTIONS', 'SAFT32kHz8BitStereo', 'DISPID_SOTDisplayUI',
    'SP_VISEME_16', 'DISPID_SLPs_NewEnum', 'DISPID_SRCEventInterests',
    'DISPID_SPRuleNumberOfElements', 'SRSEIsSpeaking',
    'ISpStreamFormat', 'DISPID_SRGCmdLoadFromObject', 'SAFTDefault',
    'SPEI_ADAPTATION', 'SpeechWordPronounceable',
    'SPWORDPRONUNCIATION', 'SPPS_Unknown', 'SPEI_MIN_TTS',
    'SPEI_RESERVED5', 'SVSFNLPSpeakPunc',
    'DISPID_SRCreateRecoContext', 'SREAdaptation',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRs_NewEnum',
    'DISPID_SABIBufferSize', 'ISpResourceManager',
    'SPSMF_SAPI_PROPERTIES', 'SVF_None', 'ISpVoice', 'WAVEFORMATEX',
    'DISPID_SOTCId', 'SpeechDiscardType', 'SITooFast',
    'SPCONTEXTSTATE', 'DISPID_SRGRules',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SMSGetData',
    'SpeechTokenKeyUI', 'DISPID_SPPsCount',
    'DISPID_SpeechGrammarRule', 'SRSActiveAlways', 'SVP_5',
    'SpPhoneticAlphabetConverter', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSLastBookmarkId', 'ISpeechGrammarRuleState',
    'DISPID_SMSSetData', 'SpeechAddRemoveWord', 'SRADynamic',
    'DISPID_SLAddPronunciationByPhoneIds', 'SREHypothesis',
    'SITooSlow', 'DISPID_SDKSetBinaryValue',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRRGetXMLResult',
    'eLEXTYPE_USER', 'DISPID_SRCESoundEnd',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVSpeakCompleteEvent',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCCreateGrammar',
    'SPPS_SuppressWord', 'DISPID_SWFEBitsPerSample',
    'SpeechPropertyResourceUsage', 'SpWaveFormatEx',
    'DISPID_SDKSetLongValue', 'DISPID_SGRAddResource',
    'DISPID_SOTCDefault', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPERetainedSizeBytes', 'IInternetSecurityMgrSite',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPPValue',
    'DISPID_SPIProperties', 'SPBOOKMARKOPTIONS', 'STCInprocServer',
    'SDTRule', 'DISPID_SPEActualConfidence',
    ...
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SDKLCurrentUser',
    'SPEI_PHRASE_START', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEDisplayText', 'SVESentenceBoundary',
    'Speech_Max_Word_Length', 'SDKLCurrentConfig', 'SVSFIsXML',
    'DISPID_SRGetPropertyNumber', 'SPINTERFERENCE',
    'DISPID_SBSFormat', 'SRCS_Enabled', 'SGPronounciation',
    'DISPID_SVDisplayUI', 'DISPID_SGRInitialState',
    'SPDKL_CurrentConfig', 'SpeechWordType', 'SPSHT_Unknown',
    'Speech_Default_Weight', 'SpPhoneConverter', 'SPSVerb',
    'DISPID_SOTSetId', 'SRERequestUI', 'SRTReSent', 'SPPS_LMA',
    'SRAExport', 'SAFT24kHz16BitMono',
    'DISPID_SRCEPropertyNumberChange', 'SRAImport', 'SRCS_Disabled',
    'SAFTCCITT_ALaw_44kHzMono', 'SPAS_STOP', 'DISPID_SPEsCount',
    'ISpNotifySink', 'SPWF_SRENGINE', 'DISPID_SPPName', 'SP_VISEME_8',
    'eLEXTYPE_PRIVATE19', 'SAFT11kHz16BitMono',
    'DISPID_SPPEngineConfidence', 'DISPID_SRIsUISupported',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechMemoryStream',
    'DISPID_SRCRetainedAudioFormat', 'SpeechRecognizerState',
    'SPDKL_CurrentUser', 'DISPID_SLPsCount', 'SpeechRecoEvents',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGDictationUnload',
    'DISPID_SOTIsUISupported', 'SPXRO_SML',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechBookmarkOptions', 'SPRULE', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRSAudioStatus', 'SPCT_SUB_COMMAND', 'ISpeechRecoResult',
    'SPPS_RESERVED2', 'SPEVENTENUM', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_18', 'SAFTCCITT_uLaw_44kHzStereo',
    'SAFT8kHz8BitStereo', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseRule', 'SPBO_TIME_UNITS',
    'DISPID_SpeechPhraseAlternates', 'SPEI_RESERVED2',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVSFVoiceMask', 'SINoSignal',
    'DISPID_SRGCmdLoadFromResource', 'SGSEnabled',
    'ISpeechVoiceStatus', 'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE4',
    'DISPID_SGRSTsCount', 'SAFT16kHz16BitMono',
    'DISPID_SGRSTransitions', 'SPPHRASERULE',
    'DISPID_SRGDictationSetState', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVSRunningState', 'SRARoot', 'SWTDeleted', 'DISPIDSPRG',
    'SpeechAudioState', 'DISPID_SPRuleChildren',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SpeechRecoContext',
    'DISPID_SRCEHypothesis', 'SpeechTokenContext',
    'SAFT22kHz16BitStereo', 'SGSDisabled', 'DISPID_SLGetWords',
    'SPEI_RECOGNITION', 'SVP_11', 'DISPID_SDKEnumKeys',
    'SPINTERFERENCE_NONE', 'SPSLMA', 'SVEViseme',
    'SAFTADPCM_44kHzStereo', 'DISPID_SLGetPronunciations',
    'DISPID_SPRNumberOfElements', 'SDTAll', 'ISpeechObjectTokens',
    'SVP_3', 'SpeechPropertyAdaptationOn', 'DISPID_SRRAudioFormat',
    'Speech_Max_Pron_Length', 'SSTTTextBuffer', 'SpPhraseInfoBuilder',
    'SBOPause', 'ISpeechDataKey', 'DISPID_SVGetVoices',
    'SPAO_RETAIN_AUDIO', 'DISPID_SpeechObjectTokenCategory',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SASetState',
    'SpeechDataKeyLocation', 'SpeechPropertyResponseSpeed',
    'SAFTExtendedAudioFormat', 'ISpStreamFormatConverter',
    'DISPID_SGRsItem', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechRecoResult', 'ISpeechPhraseReplacements',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPANumberOfElementsInResult', 'SpObjectToken',
    'DISPID_SLWsItem', 'SPDKL_LocalMachine', 'DISPID_SASState',
    'SpVoice', 'SAFTADPCM_22kHzStereo', 'DISPID_SAFType',
    'SREPropertyStringChange', 'SRTExtendableParse',
    'SAFTNonStandardFormat', 'DISPID_SPAsItem', 'SPEI_SOUND_END',
    'SpSharedRecognizer', 'DISPID_SABufferNotifySize',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVWaitUntilDone',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechRecognizer',
    'SpeechVoiceSkipTypeSentence', 'SREPropertyNumChange',
    '_SPAUDIOSTATE', 'ISpStream', 'SVSFPersistXML',
    'DISPID_SPEAudioSizeTime', 'ISpeechLexiconWords',
    ...
    'DISPID_SPPChildren', 'SPEI_START_SR_STREAM',
    'SpeechVoiceSpeakFlags', 'DISPID_SRCSetAdaptationData',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPIReplacements', 'ISpPhraseAlt', 'SVSFParseSapi',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechMemoryStream', 'ISpRecoCategory', 'SASStop',
    'ISpeechPhraseProperties', 'SPLO_DYNAMIC',
    'DISPID_SRCRetainedAudio', 'SPRS_INACTIVE', 'SPSTREAMFORMATTYPE',
    'SGRSTTRule', 'ISpMMSysAudio', 'DISPID_SMSAMMHandle',
    'SPCT_DICTATION', 'SVF_Stressed', 'DISPID_SOTMatchesAttributes',
    'SpFileStream', 'DISPID_SRSetPropertyNumber',
    'DISPID_SLRemovePronunciation', 'eLEXTYPE_PRIVATE6',
    'SRESoundStart', 'DISPID_SRCResume', 'ISpeechWaveFormatEx',
    'STSF_LocalAppData', 'SpeechAudioFormatGUIDText',
    'SPAUDIOBUFFERINFO', 'SAFTCCITT_ALaw_22kHzStereo', 'SPBO_PAUSE',
    'SpeechStreamFileMode', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SGRSTsItem', 'DISPID_SLAddPronunciation', 'SVSFParseMask',
    'SPCS_DISABLED', 'SPEI_INTERFERENCE', 'ISpeechPhraseAlternates',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_19',
    'SPPS_Noncontent', 'ISpeechVoice', 'DISPID_SPRulesCount',
    'SP_VISEME_4', 'SPCATEGORYTYPE', 'DISPID_SVPriority',
    'DISPID_SRCEPhraseStart', 'DISPID_SRCERequestUI',
    'DISPID_SRGReset', 'DISPID_SVSLastResult',
    'SAFTADPCM_11kHzStereo', 'SAFT12kHz16BitMono', 'DISPID_SLWType',
    'ISpProperties', 'DISPID_SRCVoicePurgeEvent', 'SpeechLexiconType',
    'DISPID_SGRAttributes', 'DISPID_SpeechPhraseReplacements',
    'SAFT8kHz8BitMono', 'DISPID_SDKGetlongValue', 'SpShortcut'
]
